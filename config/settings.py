"""
Django settings — Gestión Social (Actuarial Cortex).
Listo para despliegue en Hugging Face Spaces u otro host.
"""
import os
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-cambiar-en-produccion')
